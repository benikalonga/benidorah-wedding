...
const en = {
  ...
  giftRegistry: {
    ...
    preference:
      "As a couple, we'd prefer a contribution toward our life together — feel free to make a deposit, or bring cash on the day, using the account details alongside.",
  },
  rsvp: {
...
const fr: typeof en = {
  ...
  giftRegistry: {
    ...
    preference:
      "En tant que couple, nous préférerions une contribution pour notre nouvelle vie ensemble — n'hésitez pas à faire un dépôt, ou à apporter une enveloppe le jour J, avec les coordonnées bancaires ci-contre.",
  },
  rsvp: {
