 ...
 */
export function pickDb(en: string, fr: string | null | undefined, locale: Locale): string {
...
const en = {
    ...
    giftRegistry: {
      eyebrow: "With Love",
      title: "Gift Registry",
      intro: "Your presence will be the best gift of all. If you'd love to spoil us a little too, you are welcome to do so.",
      ...
      preference: "As a couple, we'd prefer a deposit toward a gift's value or its cash equivalent on the day. Pick one from the list below.",
    ...
    rsvp: {
      ...
      title: "RSVP",
      lockedMessage: "RSVP is only available through your personal invitation link. If you've received an invite, open the link shared with you on WhatsApp to respond.",
    ...
    wishWall: {
      ...
      subcopy: "Pinch or scroll to zoom, drag to explore — updates live as wishes come in.",
    ...
    shareMoment: {
      ...
      lockedMessage: "Only invited guests can share a moment — open the personal invite link sent to you on WhatsApp to upload your photos and videos here.",
...
const fr: typeof en = {
    ...
    history: {
      ...
      title: "Histoire",
      description: 'Du jour où nous nous sommes rencontrés, au jour où nous dirons « oui ».',
    ...
    giftRegistry: {
      ...
      intro: "Votre présence sera le plus beau des cadeaux. Si vous souhaitez tout de même nous gâter un peu, vous êtes les bienvenus.",
      ...
      preference: "En tant que couple, nous préférerions un dépôt correspondant à la valeur d'un cadeau, ou son équivalent en argent le jour J. Choisissez-en un dans la liste ci-dessous.",
      receivedThanks: "Reçu avec gratitude",
      alreadyClaimed: "Déjà réservé",
      iWillGiftIt: "Je vais l'offrir",
      hideDetails: "Masquer les coordonnées bancaires",
      bringCash: "J'apporterai de l'argent liquide le jour J",
      claiming: "Réservation…",
      claimError: "Impossible de réserver ce cadeau — quelqu'un vient peut-être de le réserver.",
      showLess: "Voir moins",
    ...
    rsvp: {
      ...
      title: "RSVP",
      lockedMessage: "Le RSVP n'est disponible qu'à partir de votre lien d'invitation personnel. Si vous avez reçu une invitation, ouvrez le lien partagé sur WhatsApp pour répondre.",
    ...
    wishWall: {
      ...
      subcopy: "Pincez ou faites défiler pour zoomer, glissez pour explorer — mis à jour en direct au fil des vœux.",
    ...
    shareMoment: {
      ...
      description: "Prenez la photo, envoyez-la — tout le monde la voit en direct.",
      lockedMessage: "Seuls les invités peuvent partager un instant — ouvrez le lien d'invitation personnel envoyé sur WhatsApp pour y publier vos photos et vidéos.",
      namePlaceholder: "Votre nom",
      uploading: "Envoi en cours…",
      uploadFailed: "Échec de l'envoi",
      uploadFailedConn: "Échec de l'envoi — vérifiez votre connexion et réessayez.",
    ...
    installPrompt: {
      message: "Installez l'application Beni & Dorah pour un accès rapide le jour J.",
      install: "Installer",
      later: "Plus tard",
    },
    lightbox: {
